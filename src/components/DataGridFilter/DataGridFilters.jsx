...
const DataGridFilters = (props) => {
    ...
    return (
        ...
        /> */}
            ...
            {/* DOWNLOAD ICON */}
            <CustomTooltipBlack title='Download' placement='top'>
                <IconButton
            ...
            {isWithCustomizeColumn && (
                <CustomTooltipBlack title='Customize Columns' placement='top'>
                    <IconButton
                        className={classes.iconButton}
                        onClick={(event) =>
                    ...
                    (item, index) =>
                        item.field !== 'actions' && (
                            <CustomMenuItem
                                ...
                                onClick={() =>
                                    handleColumnsMenuItemClick(item, index)
                                }
                            >
                                {/* CHECKBOX */}
                                <Checkbox
                                    checked={!selectedColumnList[index].hide}
                                />
